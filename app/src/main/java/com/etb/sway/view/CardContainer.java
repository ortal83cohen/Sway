...
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mOrientation == Orientation.Disordered) {
            ...
            childWidth = (int) ((R1 * Math.cos(DISORDERED_MAX_ROTATION_RADIANS) - R2 * Math
                    .sin(DISORDERED_MAX_ROTATION_RADIANS)) / Math
                    .cos(2 * DISORDERED_MAX_ROTATION_RADIANS));
            childHeight = (int) ((R2 * Math.cos(DISORDERED_MAX_ROTATION_RADIANS) - R1 * Math
                    .sin(DISORDERED_MAX_ROTATION_RADIANS)) / Math
                    .cos(2 * DISORDERED_MAX_ROTATION_RADIANS));
        } else {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                ValueAnimator animator = ObjectAnimator.ofPropertyValuesHolder(mTopCard,
                        ...
                        PropertyValuesHolder.ofFloat("rotation", (float) Math.toDegrees(
    ...
    private class GestureListener extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (Math.abs(dx) > mTouchSlop &&
                ...
                boundsRect.set(0 - topCard.getWidth() - 100, 0 - topCard.getHeight() - 100,
