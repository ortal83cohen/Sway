...
//        expandableDraggableSwipeableFragment.setAdapter(adapter);
    ...
    private com.etb.sway.view.SimpleCardStackAdapter getSimpleCardStackAdapter() {
        ...
        adapter.add(new com.etb.sway.model.CardModel(1, "Verzetsmuseum",
        ...
        adapter.add(new com.etb.sway.model.CardModel(2, "Van Gogh Museum",
                ...
                4.881065));
        adapter.add(new com.etb.sway.model.CardModel(3, "Anne Frank House",
                ...
                4.883944));
        adapter.add(new com.etb.sway.model.CardModel(4, "Vondelpark",
        ...
        adapter.add(new com.etb.sway.model.CardModel(5, "National Monument",
                ...
                4.893680));
        adapter.add(new com.etb.sway.model.CardModel(6, "Albert Cuyp Market",
